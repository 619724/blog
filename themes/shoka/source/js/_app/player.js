...
const mediaPlayer = function (t, config) {
    ...
    var lyrics = {
        ...
        create: function (box) {
            ...
            if (raw.startsWith('http')) this.fetch(raw, callback);
            else callback(raw);
        },
    ...
    var preview = {
        ...
        create: function () {
            ...
            this.el.innerHTML = '<div class="cover"><div class="disc"><img src="' + current.cover + '" class="blur" /></div></div>' + '<div class="info"><h4 class="title">' + current.name + '</h4><span>' + current.artist + '</span>' + '<div class="lrc"></div></div>';
    ...
    var progress = {
        ...
        create: function () {
            ...
            if (current) {
                if (this.el) {
                    this.el.parentNode.removeClass('current').removeEventListener(utils.nameMap.dragStart, this.drag);
                    this.el.remove();
                }
        ...
        seeking: function (type) {
            if (type) this.el.addClass('seeking');
            else this.el.removeClass('seeking');
        },
